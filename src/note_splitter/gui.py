...
#         [sg.Button("open file browser"), sg.T(" or "), sg.Button("find by keyword")],
#         [
#             sg.InputText(
...
#                 sg.InputText(
#                     settings["split_attrs"].get("level", ""),
...
#                 )
#             ],
#             [sg.Button("Split all"), sg.Button("Split selected"), sg.Button("Close")],
#         ]
#     )
...
#     return [
#         sg.Text(
#             pattern_name, size=(20, 1), auto_size_text=False, justification="right"
#         ),
#         sg.InputText(value, key=f"change_{name}", size=(55, 1), enable_events=True),
#     ]


# def create_hyperlink(
#     text: str, url: str, font: tuple[str, int, str] = None
# ) -> sg.Text:
...
# def create_split_summary_window(
#     notes: list[note.Note], listbox_key: str
# ) -> sg.Window:
...
#         [[sg.HorizontalSeparator()], [sg.Button("OK", key="OK")]]
#     )
...
#             window.close()
#             return
#         notes = handle_note_listbox_event(
#             event, values, window, notes, listbox_key, all_notes
#         )
...
# def request_confirmation(event: str, note_count: int) -> bool:
...
#         if (
#             event.startswith(key_prefix)
#             and (note_count > 5 or key_prefix == "-DELETE")
#         ):
#             answer = sg.popup_yes_no(
#                 f"Are you sure you want to {description} {note_count} notes?",
#                 title="Confirm",
#                 keep_on_top=True,
#             )
#             if answer != "Yes":
