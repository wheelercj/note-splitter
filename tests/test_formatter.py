...
from note_splitter import formatter_, tokens
...
def test_format():
    ...
    frontmatter = {'title': 'This is a title',
...
def test_normalize_headers():
    ...
    content = '\n'.join([section[0].content,
                         section[1].content,
                         section[2].content,
                         section[3].content])
    assert content == '# This is a title\n' \
                      'This is some text\n' \
                      '## This is a sub-title\n' \
...
def test_get_section_title_without_header():
    ...
    assert 'This is text in a section.' == \
        formatter_.Formatter().get_section_title(section)
...
def test_prepend_frontmatter():
    ...
    formatter_.Formatter().prepend_frontmatter(frontmatter,
                                               'new title',
                                               section)
    assert len(section) == 4
